...
# Seleccionar el cuadro delimitador en la imagen ROI Region de Interes, Region of Interes
...
def goal_track(img, bbox):
    ...
    if(dist<=20):
        cv2.putText(img, "From downtown",(300,90),cv2.FONT_HERSHEY_SIMPLEX,0.7,(0,255,0),2)
